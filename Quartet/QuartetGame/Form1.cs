...
namespace QuartetGame
{
    public partial class Form1 : Form
    {
        ...
        CarCard B4 = new CarCard("B4", "Rinspeed Chopster", 290, 4.4, 600, 4511, 8, 6700);
        ...
        private void ShowCard(CarCard c)
        {
            ...
            labelMaxSpeed.Text = c.maxspeed.ToString();
            labelZeroToSixty.Text = c.zerotosixty.ToString();
            labelHP.Text = c.hp.ToString();
            labelCC.Text = c.cc.ToString();
            labelCylinders.Text = c.cylinders.ToString();
